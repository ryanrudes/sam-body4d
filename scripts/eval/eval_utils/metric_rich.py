...
# from eval.eval_utils.dataset_utils.configs import MainStore, builds
from eval.eval_utils.dataset_utils.pylogger import Log

from eval.eval_utils.eval_tools import (
...
from eval.eval_utils.dataset_utils.geo_transform import apply_T_on_points, compute_T_ayfz2ay
...
from eval.eval_utils.vis.renderer import Renderer, get_global_cameras_static
from eval.eval_utils.dataset_utils.geo.hmr_cam import estimate_focal_length
from eval.eval_utils.video_io_utils import read_video_np, save_video
import imageio
...
# JOINT_NAMES = ['pelvis', 'left_hip', 'right_hip', 'spine1', 'left_knee', 'right_knee', 'spine2', 'left_ankle', 'right_ankle', 'spine3', 'left_foot', 'right_foot', 'neck', 'left_collar', 'right_collar', 'head', 'left_shoulder', 'right_shoulder', 'left_elbow', 'right_elbow', 'left_wrist', 'right_wrist', 'jaw', 'left_eye_smplhf', 'right_eye_smplhf', 'left_index1', 'left_index2', 'left_index3', 'left_middle1', 'left_middle2', 'left_middle3', 'left_pinky1', 'left_pinky2', 'left_pinky3', 'left_ring1', 'left_ring2', 'left_ring3', 'left_thumb1', 'left_thumb2', 'left_thumb3', 'right_index1', 'right_index2', 'right_index3', 'right_middle1', 'right_middle2', 'right_middle3', 'right_pinky1', 'right_pinky2', 'right_pinky3', 'right_ring1', 'right_ring2', 'right_ring3', 'right_thumb1', 'right_thumb2', 'right_thumb3', 'nose', 'right_eye', 'left_eye', 'right_ear', ...]
...
class MetricMocap:
    def __init__(self, body_model_path):
        ...
        # SMPL
        self.smplx_model = {
            "male": make_smplx("rich-smplx", body_model_path=body_model_path, gender="male"),
            "female": make_smplx("rich-smplx", body_model_path=body_model_path, ggender="female"),
            "neutral": make_smplx("rich-smplx", body_model_path=body_model_path, ggender="neutral"),
        }
