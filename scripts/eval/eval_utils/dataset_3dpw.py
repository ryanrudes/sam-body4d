...
from dataset_utils.pylogger import Log
from dataset_utils.wis3d_utils import make_wis3d, add_motion_as_lines
from dataset_utils.geo_transform import compute_cam_angvel
from dataset_utils.geo.hmr_cam import estimate_K, resize_K
from dataset_utils.geo.flip_utils import flip_kp2d_coco17

VID_HARD = []

class ThreedpwSmplFullSeqDataset(data.Dataset):
    def __init__(self, label_path, flip_test=False, skip_invalid=False):
        super().__init__()
        ...
        self.threedpw_dir = Path(label_path)
