...
class MetricMocap:
    def __init__(self, body_model_path, emdb_split=1):
        """
        Args:
        ...
        self.smpl_model = {"male": make_smplx("smpl", body_model_path=body_model_path, gender="male"), "female": make_smplx("smpl", body_model_path=body_model_path, gender="female")}
