...
from eval.eval_utils.dataset_utils.geo_transform import apply_T_on_points, transform_mat, compute_cam_angvel
from eval.eval_utils.dataset_utils.wis3d_utils import make_wis3d, add_motion_as_lines
from eval.eval_utils.smplx_utils import make_smplx
from pytorch3d.transforms import axis_angle_to_matrix, matrix_to_axis_angle
from eval.eval_utils.dataset_utils.geo.hmr_cam import resize_K
...
class RichSmplFullSeqDataset(data.Dataset):
    def __init__(self, label_path, vid_presets=None):
        """
        Args:
