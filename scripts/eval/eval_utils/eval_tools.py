...
import torch
import numpy as np
from vis_vertices import save_smpl_overlap_ply_single
...
def compute_camcoord_metrics(batch, pelvis_idxs=[1, 2], fps=30, mask=None):
    ...
    # save_path_p = "ply_outputs/" + "cafe_0_pred_verts_before"
    # # save_path_t = "ply_outputs/" + "car_0_targ_verts_before"

    # os.makedirs(save_path_p, exist_ok=True)
    # # os.makedirs(save_path_t, exist_ok=True)
 
    # pred_j3d_a = pred_verts[:-1]
    # pred_j3d_b = pred_verts[1:]

    # target_j3d_a = target_verts[:-1]
    # target_j3d_b = target_verts[1:]

    # for i in range(len(pred_j3d_a)):
    #     save_smpl_overlap_ply_single(pred_j3d_a, pred_j3d_b, i, f"{save_path_p}/verts_overlap_{i}.ply")
    ...
    # for i in range(len(target_j3d_a)):
    #     save_smpl_overlap_ply_single(target_j3d_a, target_j3d_b, i, f"{save_path_t}/verts_overlap_{i}.ply")
    ...
    # save_path_p = "ply_outputs/" + "walkUphill_0_pred_verts"
    # save_path_t = "ply_outputs/" + "walkUphill_0_targ_verts"
