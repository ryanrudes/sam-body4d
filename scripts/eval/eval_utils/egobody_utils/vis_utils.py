...
VIS_KEYS = ["input_noisy", "input", "masked", "pred_abs", "pred_rel", "pred_coarse", "pred", "gt"]
VIS_COLOR_LIST = [plt.get_cmap("tab10")(i)[:3] for i in range(8)]
VIS_COLOR_DICT = dict(zip(VIS_KEYS, VIS_COLOR_LIST))

# VIS_COLOR_DICT = {
#     "gt": [255 / 255, 102 / 255, 102 / 255],
#     "input": [255 / 255, 24 / 255, 24 / 255],
#     "masked": [219 / 255, 199 / 255, 123 / 255],
#     "pred": [90 / 255, 135 / 255, 247 / 255],
# }
# VIS_TRANS_DICT = {
#     "input": -1.5,
#     "masked": -0.5,
...
def vis_skeleton(
    ...
    for limb in limbs:
        ...
        arrow = o3d.geometry.TriangleMesh.create_arrow(
            ...
            cone_radius=0.001,
            cylinder_height=bone_length,
            cone_height=0.001,
        )
        mat = rotation_matrix_from_vectors(
            np.array([0, 0, 1]), joints[limb[1]] - joints[limb[0]]
        )
        ...
        elif mask_scheme in ["lower", "video", "full", "upper"]:
        ...
        # TODO: this part is currently moved outside
