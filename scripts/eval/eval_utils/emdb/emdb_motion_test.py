...
from eval.eval_utils.dataset_utils.geo.hmr_cam import estimate_K, resize_K
from eval.eval_utils.geo.flip_utils import flip_kp2d_coco17
...
class EmdbSmplFullSeqDataset(data.Dataset):
    def __init__(self, label_path, split=1, flip_test=False):
        """
