...
class offline_app:
    ...
    def on_4d_generation(self, video_path: str=None):
        ...
        for i in tqdm(range(0, n, batch_size)):
            ...
            batch_boxes = [bboxes[i:i + batch_size] for bboxes in self.RUNTIME['bboxes']]
            # Process with external mask
            mask_outputs, id_batch, empty_frame_list = process_image_with_bbox(self.sam3_3d_body_model, batch_images, batch_boxes, idx_path, idx_dict, mhr_shape_scale_dict, occ_dict)
